...
export function FloatButton() {
  ...
  return (
    <button
      id='floatButton'
      className={twMerge(
        'group fixed bottom-8 right-8 hidden select-none items-center overflow-hidden rounded-md border-2 border-zinc-700 bg-light p-1 font-bold shadow-md prose-p:m-0 dark:border-zinc-300 dark:bg-dark',
